...
Tidak perlu ada `targetConfigs/` sendiri kalau pakai predefined ccxml global — CCS akan pakai yang di-set di **Window &rarr; Preferences &rarr; Code Composer Studio &rarr; Debug &rarr; Target Configurations**.
